...
// // const verifyOtpRoutes = require('./auth/verify-otp');
...
const forgotPasswordRoutes = require('./forgot-password'); // Fixed path

  const verifyOtpRoutes = require('./verify-otp'); // Fixed path
//  console.log('Type of forgotPasswordRoutes:', typeof verifyOtpRoutes);
